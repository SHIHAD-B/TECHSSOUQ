      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            {user &&user.email==='techssouquae@gmail.com' && (
              <Link 
                href="/admin" 
          ...
          <div className="hidden md:flex flex-1 max-w-md mx-8">
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-amber-400 focus:ring-1 focus:ring-amber-400 transition-all duration-300"
              />
              {searchQuery.trim() !== '' && (
                <button
                  type="button"
                  ...
                  className="absolute right-2 top-1/2 -translate-y-1/2 p-1 text-gray-300 hover:text-white hover:bg-gray-700 rounded transition-colors"
                >
                        ...
                        <div className="px-4 py-3">
                          ...
                          <div className="space-y-1">
                            <button
                              ...
                              className={`flex w-full items-center gap-2 px-2 py-2 rounded-md text-sm transition-colors hover:bg-gray-700 ${theme === 'system' ? 'text-amber-400' : 'text-gray-300'}`}
                            >
                            ...
                            <button
                              ...
                              className={`flex w-full items-center gap-2 px-2 py-2 rounded-md text-sm transition-colors hover:bg-gray-700 ${theme === 'light' ? 'text-amber-400' : 'text-gray-300'}`}
                            >
                            ...
                            <button
                              ...
                              className={`flex w-full items-center gap-2 px-2 py-2 rounded-md text-sm transition-colors hover:bg-gray-700 ${theme === 'dark' ? 'text-amber-400' : 'text-gray-300'}`}
                            >
            ...
            <div className="px-4 py-6 space-y-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-amber-400"
                />
                {searchQuery.trim() !== '' && (
                  <button
                    type="button"
                    aria-label="Search"
                    onClick={handleSearchSubmit}
                    className="absolute right-2 top-1/2 -translate-y-1/2 p-1 text-gray-300 hover:text-white hover:bg-gray-600 rounded transition-colors"
                  >
                    <Search className="w-5 h-5" />
                  </button>
                )}
