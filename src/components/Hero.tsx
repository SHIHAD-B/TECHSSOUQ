      ...
      <div className="relative z-10 text-center w-full px-4 sm:px-6 lg:px-8 mb-10">
                ...
                <Link href={`/product/${product._id}`} key={product._id}>
                  ...
                  >
                    ...
                    {product.discount && product.discount !== '0% OFF' && (
                      ...
                      <div className="absolute z-10 top-4 right-4 bg-gradient-to-r from-red-500 to-pink-500 text-gray-100 px-3 py-1 rounded-full text-sm font-bold animate-pulse">
                        {product.discount}
                      </div>
                    )}
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-center items-center gap-2">
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-400 font-bold text-xl flex items-center gap-2">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto text-center">
          <div className="bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-xl transition duration-300">
            ...
            <h3 className="text-xl font-semibold text-white mb-1">Cash on Delivery</h3>
            <p className="text-gray-400 text-sm">Pay only when your order arrives at your doorstep.</p>
          </div>

          <div className="bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-xl transition duration-300">
            <div className="text-4xl mb-3">🚚</div>
            <h3 className="text-xl font-semibold text-white mb-1">Fast Home Delivery</h3>
            <p className="text-gray-400 text-sm">Quick and safe delivery to your location.</p>
          </div>

          <div className="bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-xl transition duration-300">
            <div className="text-4xl mb-3">🛒</div>
            <h3 className="text-xl font-semibold text-white mb-1">Easy Shopping Experience</h3>
