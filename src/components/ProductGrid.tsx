            ...
            <div key={product._id} className="group bg-gray-700 rounded-lg p-6 hover:bg-gray-600 transition-all duration-300 transform hover:scale-105 hover:shadow-xl h-full flex flex-col">
                ...
                <button
                  ...
                  className={`absolute top-2 left-2 p-2 rounded-full transition-all duration-300 ${
                    isFavorite(product._id) 
                      ...
                      : 'bg-gray-800 bg-opacity-80 text-gray-300 hover:bg-red-500 hover:text-white'
              ...
              <div className="flex gap-2 mt-auto">
                <Link
                  ...
                  className="flex-1 bg-gray-600 hover:bg-gray-500 text-white px-4 py-2 rounded text-sm transition-colors text-center"
                >
                  View Details
                </Link>
                <button 
                  ...
                  className={`flex-1 bg-amber-600 hover:bg-amber-700 text-white px-4 py-2 rounded text-sm transition-colors flex items-center justify-center gap-2 ${
