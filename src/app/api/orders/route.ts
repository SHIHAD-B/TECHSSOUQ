...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (typeof body.shippingAddress === 'object') {
      const requiredAddressFields = ['name', 'phone', 'secondaryPhone', 'email', 'address', 'city', 'state', 'region', 'zipCode', 'country']
      ...
      // Handle backward compatibility - convert string to object structure
