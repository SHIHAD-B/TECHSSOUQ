              ...
              <div className="lg:col-span-1">
                <div className="bg-gray-800 rounded-lg shadow-md p-6 sticky top-24 border border-gray-700">
                  ...
                  <button
                    ...
                    className={`w-full bg-gradient-to-r from-amber-500 to-amber-600 text-white font-medium py-3 px-6 rounded-lg transition-all duration-300 flex items-center justify-center gap-2 ${validating ? 'opacity-70 cursor-not-allowed' : 'hover:from-amber-600 hover:to-amber-700'}`}
                  >
                    {validating ? (
                      <>
