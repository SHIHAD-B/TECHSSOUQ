...
import { ArrowLeft, Star, ShoppingCart, Heart, Check, ZoomIn, Filter, SortAsc, SortDesc, X, ChevronLeft, ChevronRight, Loader2 } from 'lucide-react'
                  ...
                  {product.colors.map((color, index) => (
                    <button
                      ...
                      className={`flex items-center gap-2 px-4 py-2 rounded-lg border transition-colors ${
                        selectedColor === index
                          ? 'border-amber-400  bg-opacity-10 text-amber-400'
                          : color.inStock
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                <button
                  ...
                  disabled={!product.inStock || operationLoading === 'cart'}
