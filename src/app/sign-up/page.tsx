...
import { Loader2, Mail, Lock, Eye, EyeOff, CheckCircle, AlertCircle, ArrowRight, ArrowLeft, Home, User, Phone, MapPin, Check } from 'lucide-react'
  ...
  const handleEmailSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        // Redirect to verify email page for manual sign-ups
        try {
