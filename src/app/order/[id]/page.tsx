                  ...
                  {typeof order.shippingAddress === 'object' && order.shippingAddress ? (
                    <div className="space-y-1">
                      ...
                      {order.shippingAddress.secondaryPhone && (
                        <p className="text-white">{order.shippingAddress.secondaryPhone}</p>
                      )}
                      <p className="text-white">{order.shippingAddress.email}</p>
                      <p className="text-white">{order.shippingAddress.address}</p>
                      <p className="text-white">{order.shippingAddress.city}, {order.shippingAddress.state} {order.shippingAddress.zipCode}</p>
                      <p className="text-white">{order.shippingAddress.region}, {order.shippingAddress.country}</p>
                    </div>
                  ) : (
            ...
            <div className="bg-gray-800 rounded-lg p-6">
              ...
              <div className="space-y-3">
                ...
                {order.status === 'delivered' && order.paymentStatus === 'paid' ? (
                  ...
                  <div className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gray-700 text-gray-400 rounded-lg cursor-not-allowed">
                    <Download className="w-5 h-5" />
