...
export default function ProfilePage() {
  ...
  useEffect(() => {
    if (user) {
      // Get names from user prefs (Appwrite stores custom data in prefs)
      const firstName = user.prefs?.first_name || ''
      const lastName = user.prefs?.last_name || ''
  ...
  const getProviderBadge = () => {
    // Check if user has OAuth provider info
    if (user?.providerUid) {
      return (
  ...
  return (
    <ProtectedPageLoader pageName="User Profile">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  {isEditing ? (
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-600 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent outline-none transition-all bg-gray-700 text-white placeholder-gray-400"
                      placeholder="Enter your first name"
                    />
                  ) : (
                    <p className="px-4 py-3 bg-gray-700 rounded-lg text-white">
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <p className="w-full pl-10 px-4 py-3 bg-gray-700 rounded-lg text-gray-300">
                      {formData.email}
                    </p>
                  </div>
