            ...
            <div className="bg-gray-800 rounded-xl p-6 sticky top-8">
                ...
                {cart.items.map((item) => (
                  <div key={item._id} className="flex items-center gap-4">
                    ...
                    <div className="text-right">
                      <p className="text-amber-400 font-bold">AED {parseFloat(item.productId.price.toString().replace(/[^0-9.]/g, '')) || 0}</p>
                      {item.productId.originalPrice && (
                        <p className="text-gray-400 text-sm line-through">
                          AED {parseFloat(item.productId.originalPrice.toString().replace(/[^0-9.]/g, '')) || 0}
                        </p>
                      )}
                    </div>
                  </div>
              ...
              <div className="space-y-3 border-t border-gray-700 pt-4 mb-6">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-white">AED {discount.toFixed(2)}</span>
                </div>
