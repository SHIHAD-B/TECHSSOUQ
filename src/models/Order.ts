...
// Address schema for storing full address details
...
const orderSchema = new mongoose.Schema({
  ...
  // Store full address details instead of just a string
  shippingAddress: {
    type: addressSchema,
    required: true
  },
  // Keep the old shippingAddress field for backward compatibility
