...
const appwriteUrl = process.env.NEXT_PUBLIC_APPWRITE_ENDPOINT || 'https://fra.cloud.appwrite.io/v1'
const appwriteProjectId = process.env.NEXT_PUBLIC_APPWRITE_PROJECT_ID || '68aab3b8002d0e37ed5c'
